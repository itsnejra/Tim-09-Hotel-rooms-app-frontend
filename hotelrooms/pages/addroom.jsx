    ...
    <div class="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
        ...
        <form>
            <div class="grid grid-cols-2 gap-4">
                <div>
                <div class="mt-4">
    <label class="block text-sm font-medium leading-6 text-gray-900 mb-2">DODAJTE SLIKU</label>
    <div class="flex items-center justify-center w-full">
        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                <svg class="h-10 w-10 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <p class="mt-1 text-sm text-gray-500">Kliknite ili prevucite za dodavanje slike</p>
            </div>
...
<div class="mb-4">
    <div class="flex items-center justify-between">
        <label class="block text-sm font-medium leading-6 text-gray-900" for="airCondition">Klima Uređaj</label>
        <div class="flex items-center space-x-4">
            <input class="shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline" id="airCondition" type="checkbox"/>
            <div class="inline-flex items-center space-x-2">
                <label class="inline-flex items-center text-sm font-medium leading-6 text-gray-900">
                    <input type="radio" name="airConditionOption" value="da"/> Da
                </label>
                <label class="inline-flex items-center text-sm font-medium leading-6 text-gray-900">
                    <input type="radio" name="airConditionOption" value="ne"/> Ne
                </label>
            </div>
        </div>
    </div>
...
<div class="mb-4">
    <div class="flex items-center justify-between">
        <label class="block text-sm font-medium leading-6 text-gray-900" for="wifi">WiFi</label>
        <div class="flex items-center space-x-4">
            <input class="shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline" id="wifi" type="checkbox"/>
            <div class="inline-flex items-center space-x-2">
                <label class="inline-flex items-center text-sm font-medium leading-6 text-gray-900">
...
<div class="mb-4">
    <div class="flex items-center justify-between">
        <label class="block text-sm font-medium leading-6 text-gray-900" for="tv">TV</label>
        <div class="flex items-center space-x-4">
            <input class="shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline" id="tv" type="checkbox"/>
            <div class="inline-flex items-center space-x-2">
                <label class="inline-flex items-center text-sm font-medium leading-6 text-gray-900">
...
<div class="relative w-[25rem]">
                ...
                <div>
                <div class="mb-4">
    <label class="block text-sm font-medium leading-6 text-gray-900" for="category">
        Kategorija
    </label>
    <select class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="category">
...
<div class="mb-4">
    <label class="block text-sm font-medium leading-6 text-gray-900" for="bedType">
        Tip Kreveta
    </label>
    <select class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="bedType">
...
<div class="mb-4">
    <label class="block text-sm font-medium leading-6 text-gray-900" for="sector">
        Sektor
    </label>
    <select class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="sector">
        <option value="1">Sektor 1</option>
        <option value="2">Sektor 2</option>
    </select>
</div>
<div class="mb-4">
    <label class="block text-sm font-medium leading-6 text-gray-900" for="capacity">
        Kapacitet
    </label>
    <select class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="capacity">
...
<div class="mb-4">
    <label class="block text-sm font-medium leading-6 text-gray-900" for="roomNumber">
        Broj Sobe
    </label>
    <input class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="roomNumber" type="text"/>
</div>
<div class="mb-4">
    <label class="block text-sm font-medium leading-6 text-gray-900" for="view">
        Pogled
    </label>
    <input class="block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="view" type="text"/>
</div>
<div class="mb-4">
    <label class="block text-sm font-medium leading-6 text-gray-900" for="price">
        Cijena
    </label>
