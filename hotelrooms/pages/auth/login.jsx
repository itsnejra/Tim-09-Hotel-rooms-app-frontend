    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setNotification('Login uspješan!');
                ...
                setNotification('Netačan email ili lozinka');
            ...
            <div className="flex flex-row justify-center items-start w-full max-w-6xl">
                ...
                <div className="w-1/2 flex items-center justify-center ml-8 mr-250">
                    <div className="bg-white p-8 rounded-3xl shadow-lg w-full max-w-md">
                        <h4 className="text-xl text-left mb-2" style={{ letterSpacing: '0px', fontWeight: 'normal', width: 'fit-content' }}>DOBRODOŠLI NAZAD</h4>
                        <p className="text-3xl text-left mb-6" style={{ letterSpacing: '2px', fontWeight: '500', width: 'fit-content' }}>Prijavite se</p>
                        {notification && (
                        ...
                        <div className="mt-20 text-center">
                            <p className="text-sm text-gray-500">Novi korisnik? 
                                <Link href="/auth/register" legacyBehavior>
                                    <a className="font-medium text-black hover:text-black"> REGISTRIRAJTE SE OVDJE</a>
                                </Link>
                            </p>
                        </div>
